...
const MobileMenu3x: React.FC<MobileMenuProps> = ({ theme, user, activeButton, setActiveButton }) => {
    const transition = {
        duration: 0.15
    };
    const variants0 = {
...
END:VCARD`;
    ...
    return (
        ...
        >
            ...
            >
                {user?.type === 'biz' ? (
                    <svg width="36" height="36" viewBox="-4 0 32 32" version="1.1" >

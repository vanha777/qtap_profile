...
const BizSwipeFlipCard: React.FC<MediaProps> = ({ theme, media, isMobile, user }) => {
  ...
  return (
    <div style={{ perspective: '1000px', width: '320px', height: '550px' }}>
      ...
      >
        ...
        >
          <BizCard theme={theme} user={user} isMobile={isMobile} media={media} />
        </motion.div>
        <motion.div
          style={{
            width: '100%',
...
export default BizSwipeFlipCard;
